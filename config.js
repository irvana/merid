...
export const config = {
  ...
  screening: {
    ...
    maxVolatility:     u.maxVolatility     ?? null,  // null = disabled; e.g. 3.0 = reject pools above this
  ...
  management: {
    ...
    minAgeBeforeStopLoss:   u.minAgeBeforeStopLoss   ?? 5,  // minutes — don't SL on initial settlement noise
